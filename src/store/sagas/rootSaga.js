...
export default function* rootSaga() {
  yield all([watchFetchUser(),watchFetchAllCategory(),watchFetchCategoryById(),watchFindAllProductsByCatagoryId(),watcherForUserWishlist(),watcherForDeleteUserWishlist(),watcherForAddEditUserWishlist()]);
}